##---------------------------------------------------------------------------------##
## EPA_plot1.R is 2/6 scripts that visually explore data re: PM2.5 Emissions       ##
...
EPA_plot2 <- function(){
        ...
        with(data.summed.line, plot(y=data.summed.line$total, 
                          ...
                          main="EPA PM2.5 Emission Totals for Baltimore City, Maryland", 
        ...
        lines(y=data.summed.line$point, x=data.summed.line$year, type="o", col="#63CFE5", lwd=1 ,lty=2)
        lines(y=data.summed.line$nonpoint, x=data.summed.line$year, type="o", col="#5BE2A3", lwd=1 , lty=2) 
        lines(y=data.summed.line$onroad, x=data.summed.line$year, type="o", col="#DF9EDF", lwd=1, lty=2)
        lines(y=data.summed.line$nonroad, x=data.summed.line$year, type="o", col="#DDCC43", lwd=1, lty=2)
        ...
        dev.copy(png, file = "EPA_plot2.png", width=720, height=480) ## copy from the screen device to a PNG file
        print("PNG created.")
